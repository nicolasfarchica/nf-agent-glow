      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <p className="text-muted-foreground mb-6">Construimos experiencias digitale Quiero que el mensaje sea un poco mejor. Y luego te conectaré. s del futuro con tecnología de vanguardia y diseño innovador.</p>
